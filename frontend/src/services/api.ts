...
export const TRAINERS = [
  {
    ...
    bio: 'Bertrand Amoussou is the founder of MMAFit and the pioneer of MMA in France. A judo black belt from age 16, French national team athlete, and INSEP-trained fighter, he competed in Vale Tudo and Pride FC — the only Frenchman to ever win a fight in that legendary Japanese organisation. He trained the French special forces (RAID), spent 16 years campaigning to legalise MMA in France (achieved in 2020), and authored "Hors de la cage" (2024) with a preface by UFC World Champion Antonio "Minotaure" Nogueira. He trained under full-contact karate World Champion and actor Dominique Valera, and collaborated with choreographer Céline Clain (Soda Crew, France\'s Got Talent) to bring MMAFit to the Festival des Arts Martiaux in Paris.',
    specialties: ['MMA Pioneer', 'Judo Black Belt', 'Pride FC', 'INSEP Trained', 'RAID Trainer', 'Author'],
  ...
  },
  {
    ...
    bio: 'Kayode Shekoni — better known as Kayo — is a Swedish-Nigerian artist, dancer, singer, and actress with over four decades of experience on stage, in the studio, and on screen. She has represented Sweden in Eurovision, topped radio charts internationally, hosted prime-time TV shows, and delivered presence and power on stages worldwide. When she discovered MMAFit, she immediately brought the concept to Sweden. For her, movement is freedom, training is art — and every class is a show where you\'re the star.',
    specialties: ['Eurovision Artist', 'Recording Artist', 'Dancer', 'Actress', 'TV Host', 'Choreography'],
